...
SECRET_KEY = 'django-insecure-4yh)=o$ddcsgqd=62_q8^713m&c*kssfggwu70^v=y9@79skd%'
...
CORS_ALLOWED_ORIGINS = [
    ...
    # '*' Используйте для запроса от любого домена
]
...
# Stripe
API_KEY_STRIPE = os.getenv('STRIPE_API_KEY')
